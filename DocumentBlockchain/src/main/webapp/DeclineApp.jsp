...
%>
<div ><center><h2>Decline Application</h2></center><br/>
 <form id="frm" action="http://localhost:80/VerificationSystemBC1/DeclineApplication.py" method="post"  enctype="multipart/form-data">
